...
/**Agrupar as rotas privadas do projeto */
Route::middleware('autenticacao:padrao,visitante')->prefix('/app')->group(function(){
    ...
    //pedido-produto
    //Route::resource('pedido-produto', 'PedidoControllerController');
...
/**Redireciona o usário caso ele acesse uma página inexistente */
Route::fallback(function(){
    echo 'A rota acessa não existe.<a href="'.route('site.index').'">clique aqui</a> para ser redirecionado para a página inicial.';
});
